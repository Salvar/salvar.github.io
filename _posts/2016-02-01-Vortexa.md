...
A part of my job was to design how to split the world up into multiple levels of regions. The solution: A geospatial polygon classification graph in GraphML:
...
Another part of my job was fine-tuning the results of our algorithms that scanned the globe for movement patterns to find areas of interest. The three circles in the ocean are oil platforms:

![image-title](/images/overlay.png)

Sometimes design helps to clarify and understand a particular solution:
