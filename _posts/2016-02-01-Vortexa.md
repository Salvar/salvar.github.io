...
My role as Head of Product was to turn the founder's idea into a fully designed product concept using everything I knew about product design, UX research, UI design and prototyping.
...
And finally, one billion location updates from oil tankers creating the world. Once I found the right parameters it took our beefy server a week to generate the tiles:
